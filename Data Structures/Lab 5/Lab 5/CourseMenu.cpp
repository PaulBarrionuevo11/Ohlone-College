...
CourseMenu::CourseMenu() : Menu("Course Manager")
{
	...
	MenuOption op7('6', "Manage faculties", "Default");
...
void CourseMenu::facultyView() 
{
	ManageFaculty manageFaculty(50);
	manageFaculty.loadFromCSV(FACULTY_DATA);
	manageFaculty.listAllFaculty();
